...
public class FrmVacaciones extends javax.swing.JFrame {
    ...
    private ButtonGroup transporteGroup;
    /**
     * Creates new form FrmVacaciones
     */
    public FrmVacaciones() {
        initComponents();
        //BtnGroups para los botones de transporte
        transporteGroup = new ButtonGroup();
        transporteGroup.add(btnAutobus);
        transporteGroup.add(btnAvion);
        transporteGroup.add(btnAutoPropio);
        transporteGroup.add(btnAutoRentado);
        //Aquí inicializas
        cmbEstados.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CDMX", "Jalisco", "Quintana Roo", "Yucatán" }));
        cmbAtractivos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione un atractivo" }));
    ...
    // Restante código del método initComponents()
    private void cmbEstadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbEstadosActionPerformed
        String selectedState = (String) cmbEstados.getSelectedItem();
    
    if (selectedState != null) {
        // Dependiendo del estado seleccionado, actualizamos los atractivos
        switch (selectedState) {
            case "CDMX":
                cmbAtractivos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Zócalo", "Chapultepec", "Xochimilco" }));
                break;
            case "Jalisco":
                cmbAtractivos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Guadalajara", "Tequila", "Lake Chapala" }));
                break;
            case "Quintana Roo":
                cmbAtractivos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cancún", "Playa del Carmen", "Tulum" }));
                break;
            case "Yucatán":
                cmbAtractivos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Chichen Itzá", "Cenotes de Yucatán", "Progreso" }));
                break;
            default:
                cmbAtractivos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione un atractivo" }));
                break;
        ...
        // Forzamos que el ComboBox de Atractivos se repinte
        cmbAtractivos.revalidate();
        cmbAtractivos.repaint();
    }
